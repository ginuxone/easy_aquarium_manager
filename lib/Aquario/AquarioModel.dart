...
class AquarioModel {
  ...
  String key;
  String name;
  DocumentReference _measurementsReference;
  List<Map<String,dynamic>> ph=List<Map<String,dynamic>>();
  List<Map<String,dynamic>> no3=List<Map<String,dynamic>>();
  List<Map<String,dynamic>> no2=List<Map<String,dynamic>>();
  AquarioModel({
    this.key,
    this.name
  });
